...
namespace FeedApp.BlazorWasm.Services.NotificationBase
{
    ...
    {
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<FeedNotificationDto>> GetUserNotificationsAsync(int userId);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<FeedNotificationDto>> GetUserNotificationsAsync(int userId, System.Threading.CancellationToken cancellationToken);

        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<string> SetNotificationReadAsync(int userId);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<string> SetNotificationReadAsync(int userId, System.Threading.CancellationToken cancellationToken);
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<FeedNotificationDto>> GetUserNotificationsAsync(int userId)
        {
            return GetUserNotificationsAsync(userId, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<FeedNotificationDto>> GetUserNotificationsAsync(int userId, System.Threading.CancellationToken cancellationToken)
        {
            if (userId == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/Notifications/{userId}"
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<FeedNotificationDto>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new NotificationApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<string> SetNotificationReadAsync(int userId)
        {
            return SetNotificationReadAsync(userId, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<string> SetNotificationReadAsync(int userId, System.Threading.CancellationToken cancellationToken)
        {
            if (userId == null)
                throw new System.ArgumentNullException("userId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/Notifications/read/{userId}"
                    urlBuilder_.Append("api/Notifications/read/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(userId, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public partial class FeedNotificationDto
    {
